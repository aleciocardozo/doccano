...
class ProjectType(models.TextChoices):
    ...
    DOCUMENT_SENTIMENT_ANALYSIS = "DocumentSentimentAnalysis"
    ASPECT_BASED_SENTIMENT_ANALYSIS = "AspectBasedSentimentAnalysis"
...
class DocumentSentimentAnalysisProject(Project):
    @property
    def is_text_project(self) -> bool:
        return True


class AspectBasedSentimentAnalysisProject(Project):
    allow_overlapping = models.BooleanField(default=False)
    grapheme_mode = models.BooleanField(default=False)
    ...
    type_extraction = models.CharField(
        choices=[('triplet', 'Triplet'), ('quadruple', 'Quadruple')], 
        max_length=20,
        default="triplet",
    )
    ...
    @property
    def is_triplet_extraction(self) -> bool:
        return self.type_extraction == "triplet"

    @property
    def is_quadruple_extraction(self) -> bool:
        return self.type_extraction == "quadruple"
