...
from .models import (
    ...
    DocumentSentimentAnalysisProject,
    AspectBasedSentimentAnalysisProject,
)
...
class DocumentSentimentAnalysisProjectSerializer(ProjectSerializer):
    class Meta(ProjectSerializer.Meta):
        model = DocumentSentimentAnalysisProject


class AspectBasedSentimentAnalysisProjectSerializer(ProjectSerializer):
    is_triplet_extraction = serializers.ReadOnlyField()
    is_quadruple_extraction = serializers.ReadOnlyField()
    
    class Meta(ProjectSerializer.Meta):
        model = AspectBasedSentimentAnalysisProject
        fields = ProjectSerializer.Meta.fields + ["allow_overlapping", "grapheme_mode", "use_relation", "type_annotation",
            "type_extraction", "is_triplet_extraction", "is_quadruple_extraction"]
