...
Options.register(ProjectType.DOCUMENT_SENTIMENT_ANALYSIS, CSV, DOCUMENT_SENTIMENT_ANALYSIS_DIR / "example.csv")
Options.register(ProjectType.DOCUMENT_SENTIMENT_ANALYSIS, JSON, DOCUMENT_SENTIMENT_ANALYSIS_DIR / "example.json")

# Aspect Based Sentiment Analysis
ASPECT_BASED_SENTIMENT_ANALYSIS_DIR = EXAMPLE_DIR / "aspect_based_sentiment_analysis"
Options.register(ProjectType.ASPECT_BASED_SENTIMENT_ANALYSIS, JSONL, ASPECT_BASED_SENTIMENT_ANALYSIS_DIR / "example.jsonl", True)