...
DOCUMENT_SENTIMENT_ANALYSIS_DIR = EXAMPLE_DIR / "document_sentiment_analysis"
SENTENCE_SENTIMENT_ANALYSIS_DIR = EXAMPLE_DIR / "sentence_sentiment_analysis"
ASPECT_BASED_SENTIMENT_ANALYSIS_DIR = EXAMPLE_DIR / "aspect_based_sentiment_analysis"
...
class ArgAspectSentiment(BaseModel):
    column_data: str = "text"
    column_aspect: str = "aspect"
    column_opinion: str = "opinion"
    column_polarity: str = "polarity"
    column_category: Optional[str] = "category"
    column_aspect_start: str = "aspect_start"
    column_aspect_end: str = "aspect_end"
    column_opinion_start: str = "opinion_start"
    column_opinion_end: str = "opinion_end"
    encoding: encodings = "utf_8"
    delimiter: Literal[",", "\t", ";", "|", " "] = ";"
...
Options.register(
    Option(
        display_name=CSV.name,
        task_id=ProjectType.DOCUMENT_SENTIMENT_ANALYSIS,
        file_format=CSV,
        arg=ArgDelimiter,
        file=DOCUMENT_SENTIMENT_ANALYSIS_DIR / "example.csv",
    )
)
...
Options.register(
    Option(
        ...
        file_format=JSON,
        arg=ArgColumn,
        file=DOCUMENT_SENTIMENT_ANALYSIS_DIR / "example.json",
    )
)
...
Options.register(
    Option(
        display_name=CSV.name,
        task_id=ProjectType.ASPECT_BASED_SENTIMENT_ANALYSIS,
        file_format=CSV,
        arg=ArgAspectSentiment,
        file=ASPECT_BASED_SENTIMENT_ANALYSIS_DIR / "example.csv",
    )
)
Options.register(
    Option(
        display_name=JSONF.name,
        task_id=ProjectType.ASPECT_BASED_SENTIMENT_ANALYSIS,
        file_format=JSONF,
        arg=ArgNone,
        file=ASPECT_BASED_SENTIMENT_ANALYSIS_DIR / "example.json",
    )
)
