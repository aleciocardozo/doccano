...
export const DocumentSentimentAnalysis = 'DocumentSentimentAnalysis'
export const AspectBasedSentimentAnalysis = 'AspectBasedSentimentAnalysis'
...
export const canDefineSpan = (projectType: ProjectType): boolean => {
  return [SequenceLabeling, IntentDetectionAndSlotFilling, AspectBasedSentimentAnalysis].includes(projectType)
}
...
export class Project {
  ...
  constructor(
    ...
    readonly typeExtraction: string
  ) {
